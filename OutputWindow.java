...
public class OutputWindow extends javax.swing.JFrame {
    ...
    public void setConsoleText(String message) {
        String previous = txtConsole.getText();
        txtConsole.setText(previous + "\n" + message);
    }
    ...
    private void initComponents() {
        ...
        txtConsole.setFont(new java.awt.Font("Monospaced", 1, 20)); // NOI18N
        txtConsole.setLineWrap(true);
        txtConsole.setRows(5);
        txtConsole.setText("Initialising Program");
